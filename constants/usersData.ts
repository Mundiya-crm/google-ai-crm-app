...
export const usersData: User[] = [
    ...
    { id: 4, email: 'clearing@mundiya.com', password: 'password', name: 'FastLane Agent', role: 'clearing_agent', permissions: ROLE_PERMISSIONS.clearing_agent, clearingAgentId: 'agent_1' },
];